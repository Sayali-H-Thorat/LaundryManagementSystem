...
<center><input type="submit" value="login page" formaction="home.jsp"></center><br>
...
st.executeUpdate("insert into customer values('"+Fname+"','"+Mname+"','"+Lname+"','"+mobile+"','"+Add+"','"+uname+"','"+pw+"','"+EID+"')");
